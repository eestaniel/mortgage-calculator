...
const ValidResults: React.FC<ValidResultsProps> = ({
  results,
  mortgageAmount,
}) => {
  const [formattedMonthlyRepayment, setFormattedMonthlyRepayment] =
    useState("");
  ...
  useEffect(() => {
    ...
    const formattedMonthlyRepayment = results.monthlyRepayment.toLocaleString(
      undefined,
      {
    ...
    <div className={styles.content}>
      ...
      <div className={styles.results}>
        ...
        <div className={styles.result_group}>
          ...
          <p className={`preset-2 ${styles.total_amount}`}>
